...
```json
{
    ...
    "dashboard": {
        ...
        "battle_plan": {
            ...
            "execution_guide": {
                "order_type": "建议使用 市价单/限价单",
                "limit_price_detail": "如用限价单，具体挂单价格和说明",
                "suggested_lots": "建议买卖多少手（1手=100股），例如 买入1手/卖出2手/不操作",
                "order_instruction": "完整操作指令：例如 明天开盘挂限价单X.XX元买入Y手，或 开盘后直接市价卖出Z手"
            },
            "action_checklist": [
                "✅/⚠️/❌ 检查项1：多头排列",
